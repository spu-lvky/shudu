...
bool getFirstFinalSet() {
	for (int i = 0;i < 9;i++) {
		g_final_set[3 + i / 3][i % 3] = g_final_set[3 + (1 + i / 3) % 3][3 + i % 3];
		g_final_set[3 + i / 3][6 + i % 3] = g_final_set[3 + (2 + i / 3) % 3][3 + i % 3];
	}
	for (int i = 0;i < 9;i++) {
		g_final_set[i / 3][3 + i % 3] = g_final_set[3 + i / 3][3 + (i + 1) % 3];
		g_final_set[6 + i / 3][3 + i % 3] = g_final_set[3 + i / 3][3 + (i + 2) % 3];
	}
	for (int i = 0;i < 9;i++) {
		g_final_set[i / 3][i % 3] = g_final_set[(1 + i / 3) % 3][3 + i % 3];
		g_final_set[i / 3][6 + i % 3] = g_final_set[(1 + i / 3) % 3][3 + i % 3];
		g_final_set[6 + i / 3][i % 3] = g_final_set[6 + (1 + i / 3) % 3][3 + i % 3];
		g_final_set[6 + i / 3][6 + i % 3] = g_final_set[6 + (1 + i / 3) % 3][3 + i % 3];
	}
	return true;
}
